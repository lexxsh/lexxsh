...
| **날짜** | **대회명** | **수상**  |**주최 및 운영** |
| -------- | ------------|:-----------:|----------- |
|`2025.06`|[**Hand Bone Image Segmentation**](https://github.com/boostcampaitech7/level2-cv-semanticsegmentation-cv-12-lv3) |🥇 **1위** (Public) / 🥇 **1위** (Private)| 네이버 커넥트재단 |
|`2024.11`|[**2025 Bias-A-Thon : Bias 대응 챌린지 <Track 2>**](https://dacon.io/competitions/official/236487/overview/description) |🥇 **7위** (Public) / 🥇 **6위** (Private) - 장려상 수상| 성균관대 지능형멀티미디어연구센터 & 딥페이크연구센터 & 데이콘 |
